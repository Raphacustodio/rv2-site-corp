...
const SOLUTIONS: Solution[] = [
  ...
  },
  {
    ...
    status: "Disponível", color: "green",
    features: ["Geração de pacotes vinculados às OPs", "Etiquetas com QR Code (com tipos e modelos)", "Controle de volumes e quantidades", "Rastreabilidade dos pacotes", "Conferência por leitura de QR Code"],
