...
const SOLUTIONS = [
  ...
  {
    key: "pacotes", title: "Suite: Controle de Pacotes", category: "Gestão da Produção",
  ...
  {
    key: "coleta", title: "Suite: Carrega & Coleta", category: "Logística Industrial",
  ...
  {
    key: "terceiriza", title: "Suite: Terceiriza", category: "Industrialização Externa",
  ...
  {
    key: "compras", title: "Suite: Compras & Aprovações", category: "Gestão de Compras",
