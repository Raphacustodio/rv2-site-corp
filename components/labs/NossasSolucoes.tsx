...
const SOLUTIONS: Solution[] = [
  {
    ...
    features: ["Documentos fiscais", "Boletos e avisos de cobrança", "Compras", "Eventos do ERP", "Roadmap de outros gatilhos de disparo"],
  ...
  },
  {
    ...
    desc: "Gerencia os pacotes gerados a partir das Ordens de Produção, conectando o processo físico e garantindo rastreabilidade desde a preparação até o embarque.",
    status: "Disponível", color: "green",
    features: ["Geração de pacotes vinculados às OPs", "Etiquetas QRCode (com tipos e modelos)", "Controle de volumes e quantidades", "Rastreabilidade dos pacotes", "Conferência por leitura de QR Code"],
  ...
  },
  {
    ...
    status: "Disponível", color: "green",
    features: ["App para o terceiro gerir e apontar etapas", "Controle de prazos e lead time", "Alertas para atrasos e pendências", "Visão em tempo real de cada OP", "Dashboard da produção terceirizada"],
